export { ServiceCollection, } from 'monaco-editor/esm/vs/platform/instantiation/common/serviceCollection.js';
import * as editorCommon from 'monaco-editor/esm/vs/editor/common/editorCommon.js';
export { editorCommon };
export { ContentWidgetPositionPreference, OverlayWidgetPositionPreference, MouseTargetType, } from 'monaco-editor/esm/vs/editor/browser/editorBrowser.js';
export { StandaloneEditor, StandaloneDiffEditor, } from 'monaco-editor/esm/vs/editor/standalone/browser/standaloneCodeEditor.js';
export { ScrollbarVisibility } from 'monaco-editor/esm/vs/base/common/scrollable.js';
export { DynamicStandaloneServices, StaticServices, } from 'monaco-editor/esm/vs/editor/standalone/browser/standaloneServices.js';
...
export { SimpleEditorService, SimpleEditorModelResolverService, } from 'monaco-editor/esm/vs/editor/standalone/browser/simpleServices.js';
import * as modes from 'monaco-editor/esm/vs/editor/common/modes.js';
export { modes };
export { createWebWorker as actualCreateWebWorker, } from 'monaco-editor/esm/vs/editor/common/services/webWorker.js';
...
export { OverviewRulerLane, EndOfLinePreference, DefaultEndOfLine, EndOfLineSequence, TrackedRangeStickiness, TextModelResolvedOptions, FindMatch, } from 'monaco-editor/esm/vs/editor/common/model.js';
